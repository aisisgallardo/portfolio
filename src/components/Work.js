...
import webfpngdiscard from "../images/hohopng600discar.webp";
import hoho_homepage from "../images/hoho_homepage.webp";
import hoho_intro from "../images/hoho_intro.webp";
import hoho_store from "../images/hoho_store.webp";
import hoho_store1 from "../images/hoho_store1_.webp";
...
import cementerios from "../images/cementerios.webp";
import ceme_store from "../images/cementerios_store.webp";

import dartesanos_home from "../images/dartesanos_home.webp";
    ...
    return (
        <div className="border-container highlight-text">Hello 
            ...
            <div className="item-5 red">
                <img src={webfpngdiscard} class="img-card" alt=""/>WEB f png</div>
            ...
            <div className="item-17 img-card">
                <img src={cementerios} class="img-card" alt=""/> </div>
            <div className="item-18">
                <img src={ceme_store} class="img-card" alt=""/> </div>
            <div className="item-19">
                <img src={dartesanos_home} class="img-card" alt=""/>Dartesanos</div>
            ...
            <div className="item-21">
                <img src={dartesanos_store1} class="img-card" alt=""/> </div>
            ...
            <div className="item-24">
                <img src={severianos_home} class="img-card" alt=""/> </div>
            </div>
        </div>
    )
};
